...
class StaticAnalyzerAndroid(models.Model):
	...
	HASHUSER = models.CharField(max_length= 50, default= '')
	...
	WEBVIEW = models.BooleanField(default = False)
	HARDCODE = models.BooleanField(default = False)
	DATE = models.CharField(max_length = 50, default=datetime.now().strftime("%Y-%m-%d"))
